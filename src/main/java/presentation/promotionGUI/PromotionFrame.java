...
public class PromotionFrame extends mainFrame{
	...
	*/
	public PromotionFrame(UserVO uvo){
	
	JButton giftButton= new JButton("销售策略",new ImageIcon("GUI/promotion.png"));
	...
	JButton discountButton= new JButton("销售明细",new ImageIcon("GUI/examine.png"));
	...
	JButton voucherButton= new JButton("经营情况",new ImageIcon("GUI/qingkuang.png"));
	...
	class detailListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			containPanel.removeAll();
			SalesTablePanel s=new SalesTablePanel();
			//s.setLocation(0,0);
			containPanel.add(s);
			containPanel.paintComponents(containPanel.getGraphics());
			containPanel.repaint();
